...
# Creat the outer dictionary for all devices
devices = {}
...
for line in file:
    ...
    # Put device information inti dictionary for this one device
...
print('')
# Display a title 
print('Input converted to a list contaning dictionaries:')
